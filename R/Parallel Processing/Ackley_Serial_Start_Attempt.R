...
ackley <- function(xx)
{
  ...
  #
  # Copyright 2re013. Derek Bingham, Simon Fraser University.
  #
...
# label how many runs there will be
num_runs <- 96
...
for (i in 1:num_runs) {
  # initialize 
  initsols <- lb +  runif(n)*(ub - lb)  # generates initsols within bounds
  
  #optimize starting point
  all_results[[i]] <- optimize_start(initsols)
  }
